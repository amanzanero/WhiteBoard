...
%>
	...
	<div class="page-content container-fluid d-flex flex-column align-items-center">
		<div class="card w-100 d-flex flex-row justify-content-between align-items-center m-1" style="padding: 1em;">
			...
			<button class="btn btn-primary my-sm-2" onclick="location.reload()">Refresh <i class="fas fa-sync-alt"></i></button>
		</div>
...
%>
			...
			<div style="width: 100%">
				<form action="JoinQueue" method="GET" class="form-inline my-lg-0 d-flex justify-content-start w-100">
			      <input name="visitorAdd" class="form-control mr-sm-1 col-8" type="search" placeholder="usc username (i.e. ttrojan for ttrojan@usc.edu)">
			      <input name="course" type="hidden" value="<%=course %>">
			      <button class="btn btn-outline-primary my-sm-2" type="submit">Join &nbsp; <i class="fas fa-plus-square"></i></button>
			      <p><%=addError ? addErr.toString() : "" %></p>
			    </form>
			</div>
<%
}
